    ...
    <div className='tour__card'>
      <Card>
        ...
        <div className="card__top d-flex align-items-center justify-content-between">
            ...
            <span className="tour__rating d-flex align-items-center gap-1"><i class="ri-star-fill"></i>{avgRating === 0 ? null : avgRating}
            {totalRating === 0 ? (
              "Not rated"
            ) : (
        ...
        <div className="card__bottom d-flex align-content-center justify-content-between mt-3">
